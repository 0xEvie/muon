...
public class Application_Record_List_Fragment extends Fragment
{
    ...
    public Application_Record_List_Fragment()
    {
        // Required empty public constructor
    }

    public static Application_Record_List_Fragment newInstance()
    {
        Application_Record_List_Fragment fragment = new Application_Record_List_Fragment();
        return fragment;
    }
    ...
    public void onPrepareOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String query) {
                recyclerViewAdapter.getApplicationFilter().filter(query);
                             ...
                             Bundle savedInstanceState)
    {
        ...
        return inflater.inflate(R.layout.fragment_application_record_list, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState)
    {
        ...
        recyclerView = view.findViewById(R.id.applicationRecordListView);

        recordsToDisplay = dbManager.getRealm().where(PlatformRecord.class).equalTo("platform_type", "Application").sort("platform_title").findAll();
